...
const Alphabet = () => {
  return (
    <motion.section
      ...
      animate={{ opacity: 1 }}
    >
      <ReactHowler src={bgm} volume={0.02} playing={true} loop={true} />
      ...
      <div className="left-main-box">
        <motion.div className="speech_container">
          ...
          <motion.div className="concept-text">
            ...
            <motion.p>
              Click the buttons on the right to hear what it sounds like --&gt;
            </motion.p>
          </motion.div>
        </motion.div>
        ...
        {alphabetData.map((currLetter, index) => {
          return (
            <motion.div
              ...
              onClick={() =>
                playSound(
                  require(`../../assets/audio/AlphabetAudio/${currLetter.audio}.wav`),
                  1
                )
              }
            >
